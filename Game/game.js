...
function displayPopup(win) {
    ...
    info.innerHTML = "Remember, participants must be building their projects on the Aptos blockchain! 😉<br>Remember, participants can only use Move as their coding language to build their projects! 💡";
